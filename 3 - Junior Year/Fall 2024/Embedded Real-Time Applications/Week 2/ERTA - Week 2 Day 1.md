...
```ad-summary
title: Instructions
For each of the following topics, write down one question that you feel would effectively address the topic. Try not to repeat the same questions. Feel free to add new lines, images, whatever to support your question. Have fun!
```
...
description: "Fetching https://docs.google.com/document/d/1TfaN9fk5s064e7YU6M0HDiesKNmNH9JOWVcYpXJ6yY0/edit"
url: "https://docs.google.com/document/d/1TfaN9fk5s064e7YU6M0HDiesKNmNH9JOWVcYpXJ6yY0/edit"
```
