...
```mermaid
flowchart TD
A(Invetion of the automobile in the late 19th century, led to a boom for rubber plantations)-->B(1930s: SOutheast Asian rubber industry exploded)-->C(1940: Rubber become so crucial it became a strategic material)-->D(1941: Japan seized all the rubber lands)-->E(Synthetic rubber increased hundredfold. Met 4/5 of America's needs)
```
