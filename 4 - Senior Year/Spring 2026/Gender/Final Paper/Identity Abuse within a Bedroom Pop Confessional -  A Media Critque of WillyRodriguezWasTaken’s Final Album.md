...
To lay the necessary groundwork for uncovering the various themes found throughout WRWT's magnum opus, we must first discuss the literature surrounding gender theory, particularly as it relates to LGBTQ+ media representation. This section will introduce the critical terminology used throughout academic spaces, such as intersectionality, heteronormativity, and tokenism. Afterwards, statistical trends are clarified regarding three risks that were mentioned throughout “wetdream” and are disproportionately affected by the queer community: drug abuse, depression, and domestic abuse. By situating these issues within existing research, we can later assess how the album's lyrics reflect, challenge, and stereotype the realities documented in the literature.
##  Terminology
...
- *Biological Determinism* provides a flawed view that biology alone decides human behavior and is often used o justify gender and sexuality roles [Big Book].  
...
- *Symbolic Annihilation* is when privilege of a dominant group of people is used to trivialize, condemn, or silence smaller social groups using mass media [Big Book]. A great example of this comes from when transgender individuals are often demonized in the media, especially when it comes to participation in their preferred gender of sports  [transgender sports article].
- *Tokenism* is the sanitized representation of a character in media. In particular, a character is represented in a way that a dominant audience does not challenge their beliefs or status quo. Using tokenism can hurt how communities are represented and change the perspective of broad audiences to believe in stereotyping [Big Book].

```ad-note
Note that this is not necessarily an exhaustive list, but the following terms will popup throughout the paper.
```
...
By trying to suppress the feelings, it is actively destroying his mental health from the inside out. He is pushing all the negative thoughts he has down the road until instead of him exploding all at once, he instead slowly rots away at home.
...
The track concludes with a final line that sends off the song on a hollow mantra: "In time, we'll be fine / Tomorrow's another day." It acts as the final nail in the coffin, where the narrator manages to convince himself to stay under the desperate hope of it getting better by tomorrow. This is a fragile mask attempts to cover all the exhaustion, denial, and the sheer tragedy of loving someone who hurts you. However, the optimism is a facade as he is simply preparing himself for a cycle of perpetual survival. It’s a quiet admission of defeat: “I will endure today, and tomorrow I’ll have to endure again”. He frames his endurance as a virtue, but in reality, it is a psychological prison. He has become so desensitized to the trauma that he views his own suffering as a chore to be completed rather than a life to be escaped. By the time the song fades out, you realize he isn't waiting for the relationship to improve. Rather, he is just waiting for the next blow, convinced that the only way to survive the "now" is to lie to himself about the "later."
