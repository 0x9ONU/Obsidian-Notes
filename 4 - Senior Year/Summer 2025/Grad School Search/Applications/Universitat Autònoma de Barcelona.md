---
aliases: ["Universitat Autònoma de Barcelona"]
tags: [gradschool, applications, universitat-autònoma-de-barcelona]
...
```tasks
not done
path includes "Universitat Autònoma de Barcelona"
```
