...
# Research Experience
*Undergraduate Researcher, Evan’s Fellowship, ONU*$\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\space\space$May 2023-May 2026
...
- Researched academic articles and papers to find potential novel methods in cybersecurity.
- Developed processes to organize existing datasets and advance new methods of data collection.
- Performed simulated computer attacks to learn counteracting strategies against malicious adversaries.
- Designed a novel method to detect seven unique network threats in parallel using machine learning.
- Authored two IEEE conference papers submitted to research conferences around the country. 
- Presented research findings to academic peers and faculty at an international conference.

**Topic: Developing a Novel Transistor Sensor and Analog-to-Digital Converter Using Logarithmic Decay**
- Designed a transistor-based sensor utilizing logarithmic control signals for high dynamic range applications.
- Modeled circuit behavior in SPICE to optimize sensitivity, linearity, and signal-to-noise ratio.
- Implemented a prototype analog-to-digital conversion system leveraging time-domain signal processing.
- Published an IEEE manuscript documenting the sensor’s advantages over conventional ADC architectures.

**Topic: Educational Learning Tool for K-6 Students**
- Developed an interactive STEM learning device focused on teaching fundamental mathematics.
- Designed modular, gamified lessons integrating test functionality and problem-solving activities.
- Promoted the solution to local schools and teachers for feedback and refinement.
- Reduced the material cost to around 30 dollars allowing the device to be produced for lower-income districts.
- Presented the prototype and paper at an ASEE-sponsored conference.

**Topic: Securing Energy-Harvesting Wireless Sensor Networks**
- Researched security vulnerabilities unique to energy-harvesting and intermittently powered sensor networks.
- Simulated network performance under adversarial conditions using physical hardware with virtualized energy loss.
- Developed a lightweight statistic-based framework to detect intrusions into a network.
...
- [*”Math Quest: Arithmetic Education for Underfunded Schools”*](https://www.researchgate.net/publication/394388916_GIFTS_Paper_Math_Quest_Arithmetic_Education_for_Underfunded_Schools)
	- Presented at ASEE First Year Engineering Experience, College Park, MD$\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\space$July 2025
...
- [*“Machine Learning Algorithms for DoS and DDoS Cyberattacks Detection in Real-time Environment”*](https://www.researchgate.net/publication/379057006_Machine_Learning_Algorithms_for_DoS_and_DDoS_Cyberattacks_Detection_in_Real-Time_Environment)
	- Presented at IEEE Consumer Communications and Networking Conference, Las Vegas, NV$\quad\quad\quad\quad\quad\quad\quad\quad\quad\space\space$January 2024 
...
- [*”Enhancing Cybersecurity: A Pipeline Approach for Efficient Machine Learning Intrusion Detection*](https://www.researchgate.net/publication/375732715_Enhancing_Cybersecurity_A_Pipeline_Approach_for_Efficient_Machine_Learning_Intrusion_Detection)
	- Presented at IEEE Ubiquitous Computing, Electronics and Mobile Communication Conference, New York, NY$\quad\space\space$October 2023
	- Published on IEEE Xplore,  November 2023
# Technical and Professional Skills

| **Languages**     | **Programs** | **Tech Skills**               | **Professional Skills**      |
| ----------------- | ------------ | ----------------------------- | ---------------------------- |
| Java              | LTSpice      | Circuit Desgin                | Critical Thinking            |
| C++               | MATLAB       | Networking                    | Oral & Written Communication |
| Python            | Fusion 360   | Virtual Machines              | Problem Solving              |
| HTML              | Vivado       | Machine Learning              | Adaptability                 |
| Javascript        | Wireshark    | Digital Signal Processing     | Leadership                   |
| C#                | Github       | Knowledge of Design Processes | Time Management              |
| Assembly (RISC-V) | Blender      | 3D Printing                   | Creativity                   |
| VHDL              | Google Suite | Microcontrollers              | Conflict Resolution          |
