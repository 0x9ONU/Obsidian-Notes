...
```mermaid
flowchart LR
A(Rice seedlings are planted in flooded rice paddies)-->B(Duckling are introduced to eat weeds and provide fertilizers)-->C(Fish are introduced to eat weeds and provide fertilizers)-->D(Azolla is introduced to add nitrogen; ducks and fish keep the azolla from growing too much. Also alter water-levels to control the azolla)
```
